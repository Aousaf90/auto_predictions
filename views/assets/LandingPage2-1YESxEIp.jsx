    ...
    <>
        ...
        <div className="preloader d-flex align-items-center justify-content-center">
          <div className="preloader-inner position-relative">
            <div className="text-center">
              <img src="assets/imgs/template/loading.gif" alt="Nivia" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="main-header">
                  ...
                  <ul className="main-menu">
                    <li className="has-children">
                      ...
                      <ul className="sub-menu">
                        <li>
                          <a href="index.html">Business Solutions</a>
                        </li>
                        <li>
                          <a href="index-2.html">Marketing App</a>
                        </li>
                        <li>
                          <a href="index-3.html">Web Agency</a>
                        </li>
                        <li>
                          <a href="index-4.html">Digital Agency</a>
                        </li>
                        <li>
                          <a href="index-5.html">3D Products</a>
                        </li>
                        <li>
                          <a href="index-6.html">AI Platform</a>
                        </li>
                      </ul>
                    </li>
                    <li className="has-children">
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                      <ul>
                                        ...
                                        <li>
                                          <a href="feature.html">Features V1</a>
                                        </li>
                                        <li>
            ...
            <div className="header-right">
              <a className="btn btn-search hover-up" href="#" />
              <div className="form-search p-20 dark">
                <form action="#">
                  <input
                ...
                <div className="popular-keywords text-start mt-20">
                  <p className="mb-10 color-white">Popular search:</p>
                  ...
                  <ul className="mobile-menu font-heading">
                    ...
                    <li className="has-children">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <a href="feature-2.html">Features V2</a>
                        </li>
                        <li>
                          <a href="feature-3.html">Features V3</a>
                        </li>
                        <li>
                          <a href="contact.html">Contact us</a>
                        </li>
      ...
      <main className="main">
              ...
              <div className="container">
                <div className="box-banner-left">
                  ...
                  <p className="text-lg neutral-500 mb-55">
                    ...
                    tools to monitor trends, track performance, and create
                    better campaigns that reach more customers likely to engage
                    and convert.
                  </p>
                  <div className="d-flex mb-60">
                    <a className="hover-up mr-5" href="#">
                      <img
              ...
              <div className="col-lg-6 mb-40">
                <div className="box-padding-left-50">
                  ...
                  <p className="text-lg neutral-700">
                    ...
                    history. Founded in 1999, it gathered the best web designers
                    &amp; developers.
                  </p>
                ...
                <div className="card-preparing">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-lg neutral-700 w-85 mx-auto">
                      Mastering Your Domain with Effortless Control: Elevate
                      Your Management Experience to New Heights of Ease and
                      Efficiency.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card-preparing">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-lg neutral-700 w-85 mx-auto">
                      Achieve Business Excellence with Comprehensive Details
                      Reporting: The Key to Informed Decision-Making and
                      Strategic Growth
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card-preparing">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-lg neutral-700 w-85 mx-auto">
                      Maximizing Your Data Potential: A Deep Dive into the World
                      of Detailed Reporting for Informed, Strategic
                      Decision-Making
                    </p>
                  </div>
                </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 mb-40">
                ...
                <div className="box-buttons-feature-4">
                  <a className="btn btn-brand-4-medium mr-20" href="#">
                    Subscribe
                    <svg
                      width={22}
                      height={8}
                  ...
                  <a className="btn btn-learmore-2" href="#">
                    <span>
                      <svg
                        width={39}
                        height={38}
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      Strategic approach that involves creating and distributing
                      valuable, relevant, and engaging content to attract and
                      retain a target audience, ultimately driving brand
                      awareness.
                    </p>
                  </div>
                </div>
                ...
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      ...
                      company to adapt to changing market conditions and achieve
                ...
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      ...
                      personnel, to ensure the efficient and secure operation of
                      IT systems in alignment with business objectives.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      ...
                      digital infrastructure, ensuring scalability, resilience,
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      Signifies the enhancement of security measures, typically
                      through the use of advanced firewall technology, to
                      protect networks and systems from unauthorized access,
        ...
        <section className="section-box wow animate__animated animate__fadeIn box-how-it-work">
          <div className="container">
            <a className="btn btn-brand-4-sm" href="#">
              How It Works
            </a>
                ...
                <div className="box-border-rounded">
                  <div className="card-casestudy">
                    ...
                    <div className="card-desc">
                      <p>
                        This process is straightforward and swift, prioritizing
                        your convenience and experience. It enables you to
                        access tailored solutions and special offers swiftly,
                        ensuring you can quickly begin enjoying our services.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-casestudy">
                    ...
                    <div className="card-desc">
                      <p>
                        ...
                        certain that you attain the results you anticipate. This
                        is the ultimate step to ensure you are well on your way
                        to achieving success and revenue from your project.
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="item-review-discover">
                            <p className="text-lg">
                              I've been working with this digital marketing
                              agency for several months now, and I'm genuinely
                              thrilled with the results. Their team has a deep
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6">
                  <div className="card-pricing card-pricing-style-2 card-pricing-style-3">
                    ...
                    <div className="card-button">
                      <a className="btn btn-get-started" href="#">
                        Get started
                        <svg
                          width={23}
                          height={8}
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="card-pricing card-pricing-style-2 card-pricing-style-3 card-pricing-popular">
                    <a className="btn btn-popular" href="#">
                      Popular
                    </a>
                    <div className="card-title">
                      <h6>Professional</h6>
              ...
              <div className="col-lg-5">
                <div className="box-faq-left">
                  ...
                  <p className="text-lg neutral-700">
                    ...
                    may have on Nivia Platform &amp; Online Advertising. Also,
                    please feel free to check out our Facebook &amp; Google
                    Advertising Guides &amp; Academy. If you still can’t find
                    the answer you’re looking for, just{" "}
                    <a className="text-18-bold brand-1-1" href="#">
                      Contact us
                    </a>
                  </p>
                </div>
                ...
                >
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          ...
                          platform, and why hiring managers consistently choose
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="flush-headingTwo">
                      ...
                      >
                        Can you provide benchmarks for Facebook advertising
                        costs?
                      </button>
                    </h2>
                    <div
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="card-testimonial-3">
                          <div className="card-image">
                            <img
                              src="assets/imgs/page/homepage1/img-review.png"
                              alt="Nivia"
                            />
                          </div>
                          <div className="card-info">
                            ...
                            <div className="card-author-review">
                              <div className="card-author-info">
                                <span className="author-name">ROBERT FOX</span>
                                <span className="author-tag">@Amazon</span>
                              </div>
                      ...
                      <div className="swiper-slide">
                        <div className="card-testimonial-3">
                          <div className="card-image">
                            <img
                              src="assets/imgs/page/homepage1/img-review-2.png"
                              alt="Nivia"
                            />
                          </div>
                          <div className="card-info">
                            <p className="text-md neutral-500">
                              “I recently started using Nivia Platform, and the
                              experience has been nothing short of exceptional.
                              From the moment I made my first inquiry, their
                              team has been consistently accommodating and
                              attentive. ”
                            </p>
                            <div className="card-author-review">
                              <div className="card-author-info">
                                <span className="author-name">ALAN WALKER</span>
                                <span className="author-tag">@Facetime</span>
                              </div>
                              <div className="card-rate">
                                <img
                                  src="assets/imgs/page/homepage1/star.svg"
                ...
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="card-news">
                      ...
                      <div className="card-info">
                        <a className="heading-4" href="blog-post.html">
                        ...
                        <p className="text-md neutral-700 mt-15 mb-35">
                          ...
                          Phasellus is scelerisque turpis arcu, ut pulvinar
                          lectus tristique non. Nam laoreet, risus vel laoreet
                          laoreet, mauris
                        </p>
                        <a className="btn btn-learmore-2" href="blog-post.html">
                          <span>
                            <svg
                              width={13}
                              height={13}
                  ...
                  <div className="swiper-slide">
                    <div className="card-news">
                      ...
                      <div className="card-info">
                        <a className="heading-4" href="blog-post.html">
                          The behavior of the pain itself is important,
                          consistent with
                        </a>
                        <p className="text-md neutral-700 mt-15 mb-35">
                          Pellentesque at posuere tellus. Ut sed dui justo.
                  ...
                  <div className="swiper-slide">
                    <div className="card-news">
                      ...
                      <div className="card-info">
                        <a className="heading-4" href="blog-post.html">
                          How startups can improve their chances of getting
                          financing
                        </a>
                        <p className="text-md neutral-700 mt-15 mb-35">
                          Pellentesque at posuere tellus. Ut sed dui justo.
